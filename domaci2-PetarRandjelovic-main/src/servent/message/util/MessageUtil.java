...
public class MessageUtil {
	...
	//	AppConfig.timestampedErrorPrint(clientMessage+"");
		if (MESSAGE_UTIL_PRINTING) {
            assert clientMessage != null;
            AppConfig.timestampedStandardPrint("Got message " + clientMessage + " original sender version is "
					+clientMessage.getOriginalSenderInfo().getVersionId() + " app config version " + AppConfig.snapshotVersion.get()+" dobio mapu "+ clientMessage.getParentMap());
		}
