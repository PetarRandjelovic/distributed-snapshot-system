...
public class DelayedMessageSender implements Runnable {
	...
	public void run() {
		...
		if (MessageUtil.MESSAGE_UTIL_PRINTING) {
			AppConfig.timestampedStandardPrint("Sending message " + messageToSend + "OSVer "
					+ messageToSend.getOriginalSenderInfo().getVersionId() + " AppVer " + AppConfig.snapshotVersion.get());
		}
