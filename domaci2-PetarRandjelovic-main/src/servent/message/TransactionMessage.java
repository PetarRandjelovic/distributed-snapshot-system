...
public class TransactionMessage extends BasicMessage {
	...
	public TransactionMessage(ServentInfo sender, ServentInfo receiver, int amount, BitcakeManager bitcakeManager, int snapshotVersion, int initiatorId) {
		super(MessageType.TRANSACTION, sender, receiver, String.valueOf(amount), snapshotVersion, initiatorId);
	...
	public void sendEffect() {
		...
		if (bitcakeManager instanceof LaiYangBitcakeManager /*&&  AppConfig.snapshotVersion.get()==getSnapshotVersion()*/) {
